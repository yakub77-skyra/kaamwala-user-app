...
abstract final class Env {
  ...
  static const String supabaseUrl =
      String.fromEnvironment('KW_SUPABASE_URL');
  static const String supabaseAnonKey =
      String.fromEnvironment('KW_SUPABASE_ANON_KEY');

  /// Public Razorpay Key ID - safe to embed, required for checkout (Phase 4 5.1).
  static const String razorpayKeyId = String.fromEnvironment('KW_RAZORPAY_KEY_ID');
  ...
  static const String proxyBaseUrl =
      String.fromEnvironment('KW_PROXY_BASE_URL');

  static bool get isConfigured => supabaseUrl.isNotEmpty && supabaseAnonKey.isNotEmpty;

  /// Effective API origin for all REST calls (proxy when configured).
  static String get apiOrigin => proxyBaseUrl.isNotEmpty ? proxyBaseUrl : supabaseUrl;
}
